...
public class SYNRESTRS {
    ...
    protected List<SYNRESTR> synrestr;
    ...
    /**
     * Gets the value of the synrestr property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the synrestr property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSYNRESTR().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SYNRESTR> getSYNRESTR() {
        if (synrestr == null) {
            synrestr = new ArrayList<SYNRESTR>();
        }
        return this.synrestr;
    }
