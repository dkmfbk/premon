...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "", propOrder = {
    ...
    @XmlAttribute(name = "lemma", required = true) @XmlJavaTypeAdapter(NormalizedStringAdapter.class) protected String lemma;
    @XmlElements({ @XmlElement(name = "note", type = Note.class),
            @XmlElement(name = "roleset", type = Roleset.class) }) protected List<Object> noteOrRoleset;
