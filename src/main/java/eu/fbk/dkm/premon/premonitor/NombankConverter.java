...
public class NombankConverter extends BankConverter {
	...
	@Override
	protected void addExampleArgToSink(Type argType, String argName, URI markableURI, String f, String rolesetID) {
	...
	@Override
	protected void addRelToSink(Type argType, String argName, URI markableURI) {
	...
	@Override
	HashMap<String, URI> getFunctionMap() {
		return PMONB.mapM;
	}

	@Override
	void addInflectionToSink(URI exampleURI, Inflection inflection) {

	}

	@Override
	void addArgumentToSink(URI argumentURI, String argName, String f, Type argType, String lemma, String type, String rolesetID, URI lexicalEntryURI) {
		// F is not present in NomBank
		switch (argType) {
			case NUMERIC:
				addArgumentToSink(argName, PMONB.mapF.get(argName), argumentURI, lemma, type, rolesetID, lexicalEntryURI);
				break;
			case AGENT:
				addArgumentToSink("a", PMONB.ARGA, argumentURI, lemma, type, rolesetID, lexicalEntryURI);
				break;
		}
	}
